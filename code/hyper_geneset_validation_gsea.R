###########################################################################
#
#                            hyper_geneset_validation_gsea
#
###########################################################################
# Author: Matthew Muller
# Date: 2024-02-25
# Script Name: hyper_geneset_validation_gsea
# Output directory:
experiment <- "hyper_geneset_validation_gsea__rfe_ada/"
outdir <- file.path('output', paste0(experiment))
dir.create(outdir, showWarnings = F)

#======================== LIBRARIES ========================#
library(tidyverse)
press_reduced <- read.csv('./output/feature_selection/rfe/ada/selected_features.csv') %>% pull(1)
...
## Save and load data
# save.image(file = paste0(outdir, "/platelet_hyper_testing.RData"))
# load(file = paste0(outdir, "/platelet_hyper_testing.RData"))
...
write.table(epi_metatable_writeout, paste0(outdir, "hypercohort_metatable.csv"), sep = ",", col.names = NA, row.names = TRUE)
...
pdf(paste0(outdir, "metric_APonly_histogram.pdf"))
print(pout)
junk <- dev.off()
...
#                            rawcounttab = rawcounttable[,c(hypersamples, nothypersamples)])
testout2 <- deseqout[[1]]
write.table(testout2, paste0(outdir, "hyper_v_hypo_deseqoutput.csv"), sep = ",", col.names = NA, row.names = TRUE)
...
write.table(overlaptable, paste0(outdir, "testoverlap_overlaptable.csv"), sep = ",", col.names = TRUE, row.names = FALSE)
write.table(overlapgrouptab, paste0(outdir, "testoverlap_overlapgrouptable.csv"), sep = ",", col.names = TRUE, row.names = FALSE)
write.table(overlapsummary, paste0(outdir, "testoverlap_overlapsummary.csv"), sep = ",", col.names = TRUE, row.names = TRUE)
pdf(paste0(outdir, "testoverlap_overlapvenn.pdf"))
grid.draw(vennplot)
junk <- dev.off()
...
#======================== Get the GOIs ========================#
# get press reduced from earlier
GOI <- press_reduced
...
write.table(writeouttable, paste0(outdir, "full_hypertest_stattable.csv"), sep = ",", col.names = TRUE, row.names = FALSE)
write.table(data.frame(writeouttable[!is.na(writeouttable[,"GOIup"]),"Row.names"]), paste0(outdir, "custom_mgc_hyper_up.txt"), sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)
write.table(data.frame(writeouttable[!is.na(writeouttable[,"GOIdown"]),"Row.names"]), paste0(outdir, "custom_mgc_hyper_down.txt"), quote = FALSE, sep = "\t", col.names = FALSE, row.names = FALSE)
write.table(data.frame(GOI), paste0(outdir, "custom_mgc_all_GOI.txt"), quote = FALSE, sep = "\t", col.names = FALSE, row.names = FALSE)
...
write.table(feature_outtable, paste0(outdir, "hyper_feature_outtable.csv"), sep = ",", col.names  = NA, row.names = TRUE)

# --------------------------------- Viz and test our new PRESS sets ---------------------------------

## Some additional illustrations of this:
dir.create(paste0(outdir, "figures/"), showWarnings = FALSE, recursive = TRUE)
...
pdf(paste0(outdir, "figures/", "deseqpval_v_corr_volcano.pdf"), width = 5, height = 4, useDingbats = FALSE)
print(pout)
junk <- dev.off()
...
pout <- pout + theme_bw()
pdf(paste0(outdir, "figures/", "deseq_pval_histogram.pdf"))
print(pout)
junk <- dev.off()
...
pout <- pout + labs(title = labsparam$title, x = labsparam$x, y = labsparam$y, fill = labsparam$fill )
pout <- pout + theme_bw()
pdf(paste0(outdir, "figures/", "corr_rval_histogram.pdf"))
print(pout)
junk <- dev.off()
...
pdf(paste0(outdir, "figures/", "GOI_PCA.pdf"))
...
pdf(paste0(outdir, "figures/", "GOI_PCA_PC1andPC20.pdf"))
print(pcaplotout[[1]] + stat_ellipse())
junk <- dev.off()
...
# pdf(paste0(outdir, "figures/", "GOI_heatmap_clustered_split.pdf"), 15, 10, useDingbats = FALSE)
# pdf(paste0(outdir, "figures/", "GOI_heatmap_clustered.pdf"), 15, 10, useDingbats = FALSE)
# pdf(paste0(outdir, "figures/", "GOI_heatmap_sorted.pdf"), 15, 10, useDingbats = FALSE)
pdf(paste0(outdir, "figures/", "custGOI_deseqANDcorr_heatmap_clustered.pdf"), 15, 10, useDingbats = FALSE)
draw(summary_outhm)
junk <- dev.off()
...
pdf(paste0(outdir, "figures/", "custGOI_PCA.pdf"))
print(pcaplotout[[1]] + stat_ellipse())
junk <- dev.off()
...
overlapout <- overlap_finder(overlapinlist)
write.table(overlapout$overlaptable, paste0(outdir, "figures/", "GOI_plateletgoterm_overlaptable.csv"),
            sep = ",", col.names = TRUE, row.names = FALSE)
write.table(overlapout$overlapgrouptab, paste0(outdir, "figures/", "GOI_plateletgoterm_overlapgrouptab.csv"),
            sep = ",", col.names = TRUE, row.names = FALSE)
write.table(overlapout$overlapsummary, paste0(outdir, "figures/", "GOI_plateletgoterm_overlapsummary.csv"),
            sep = ",", col.names = TRUE, row.names = TRUE)
pdf(paste0(outdir, "figures/", "GOI_plateletgoterm_overlap_venn.pdf"))
...
outfilepathGSEA = paste0(outdir, "gsea/hyper_gseacheck/")
...
validationoutfilepath <- paste0(outdir, "validation/")
...
# make a new relative path
relative_path <- "data/raw_validation"
## 1 - PACE vs THR or EMD I think would be a good place to start
dir.create(paste0(outdir, "validation/", "pace_pacethr/"), showWarnings = FALSE, recursive = TRUE)
...
write.table(pace_pacethr_deseq, paste0(outdir, "validation/", "pace_pacethr/", "pace_pace_v_thr_wcontrol_deseq.csv"), 
...
pace_pace_v_thr_validation_out <- validation_gsea_function(indeseqtable = pace_pacethr_deseq, 
                                                           ...
                                                           validationoutfilepath = paste0(outdir, "validation/", "pace_pacethr/"))
...
write_out_intermediate_files(rawcounttable = pace_pacethr_rawcount_table, metatable = pace_pacethr_metatable, 
                             ...
                             outfilepath = paste0(outdir, "validation/", "pace_pacethr/", "intermediate_files/"), 
...
dir.create(paste0(outdir, "validation/", "harp_allmicontrol/"), showWarnings = FALSE, recursive = TRUE)
dir.create(paste0(outdir, "validation/", "harp_minocacontrol/"), showWarnings = FALSE, recursive = TRUE)
dir.create(paste0(outdir, "validation/", "harp_micadcontrol/"), showWarnings = FALSE, recursive = TRUE)
# Read in
harp_minocacontrol_rawcount_file <- file.path(relative_path, "harp-platelet/rna_processing/filtrawcounttab.txt")
...
harp_minocacontrol_meta_file <- file.path(relative_path, "harp-platelet/rna_processing/metatable_in.csv")
...
library(lubridate)
library(stringr)
harp_minocacontrol_meta_ADDON_file <- file.path(relative_path, "harp-platelet/harp-platelet-metadata-ADDON-20220823.csv")
...
write.table(harp_allmicontrol_deseq, paste0(outdir, "validation/", "harp_allmicontrol/", "harp_allmicontrol_wcontrol_deseq.csv"), 
            sep = ",", col.names = NA, row.names = TRUE)
write.table(harp_minocacontrol_deseq, paste0(outdir, "validation/", "harp_minocacontrol/", "harp_minocacontrol_wcontrol_deseq.csv"), 
            sep = ",", col.names = NA, row.names = TRUE)
write.table(harp_micadcontrol_deseq, paste0(outdir, "validation/", "harp_micadcontrol/", "harp_micadcontrol_wcontrol_deseq.csv"), 
            sep = ",", col.names = NA, row.names = TRUE)
...
harp_allmicontrol_validation_out <- validation_gsea_function(indeseqtable = harp_allmicontrol_deseq, 
                                                             ...
                                                             validationoutfilepath = paste0(outdir, "validation/", "harp_allmicontrol/"))
...
harp_minocacontrol_validation_out <- validation_gsea_function(indeseqtable = harp_minocacontrol_deseq, 
                                                              ...
                                                              validationoutfilepath = paste0(outdir, "validation/", "harp_minocacontrol/"))
# MICAD
harp_micadcontrol_validation_out <- validation_gsea_function(indeseqtable = harp_micadcontrol_deseq, 
                                                             ...
                                                             validationoutfilepath = paste0(outdir, "validation/", "harp_micadcontrol/"))


# Write out the intermediates:
write_out_intermediate_files(rawcounttable = harp_minocacontrol_rawcount_table, metatable = harp_minocacontrol_metatable, 
                             compcols = compcols, controlcols = controlcols, 
                             outfilepath = paste0(outdir, "validation/", "harp_allmicontrol/", "intermediate_files/"), 
...
# 3 COVID v Control
dir.create(paste0(outdir, "validation/", "covid_covidcontrol/"), showWarnings = FALSE, recursive = TRUE)

covid_covidcontrol_rawcount_file <- file.path(relative_path, "covid-platelet/rna_processing/filtrawcounttab.txt")
...
covid_covidcontrol_meta_file <- file.path(relative_path, "covid-platelet/rna_processing/metatable_in.csv")
...
write.table(covid_covidcontrol_deseq, paste0(outdir, "validation/", "covid_covidcontrol/", "harp_minocacontrol_wcontrol_deseq.csv"),
            sep = ",", col.names = NA, row.names = TRUE)
covid_covidcontrol_validation_out <- validation_gsea_function(indeseqtable = covid_covidcontrol_deseq,
                                                              ...
                                                              validationoutfilepath = paste0(outdir, "validation/", "covid_covidcontrol/"))
# Write out the intermediates:
write_out_intermediate_files(rawcounttable = covid_covidcontrol_rawcount_table, metatable = covid_covidcontrol_metatable, 
                             compcols = compcols, controlcols = controlcols, 
                             outfilepath = paste0(outdir, "validation/", "covid_covidcontrol/", "intermediate_files/"), 
                             labelparam = "covid_covidcontrol")

# --------------------------------- SLE validation ---------------------------------

##### SLE Control and Prot
dir.create(paste0(outdir, "validation/", "sle_slecontrol/"), showWarnings = FALSE, recursive = TRUE)
dir.create(paste0(outdir, "validation/", "sle_sleprot/"), showWarnings = FALSE, recursive = TRUE)

sle_slecontrol_rawcount_file <- file.path(relative_path, "platelet-sle/rna_processing/filtrawcounttab.txt")
sle_slecontrol_rawcount_table <- read.table(sle_slecontrol_rawcount_file, sep = "\t", header = TRUE, row.names = 1, check.names = FALSE)
sle_slecontrol_meta_file <- file.path(relative_path, "platelet-sle/rna_processing/metatable_in.csv")
...
write.table(sle_slecontrol_deseq, paste0(outdir, "validation/", "sle_slecontrol/", "sle_slecontrol_wcontrol_deseq.csv"), 
            sep = ",", col.names = NA, row.names = TRUE)
write.table(sle_sleprot_deseq, paste0(outdir, "validation/", "sle_sleprot/", "sle_sleprot_wcontrol_deseq.csv"), 
            sep = ",", col.names = NA, row.names = TRUE)

# SLE Control
sle_slecontrol_validation_out <- validation_gsea_function(indeseqtable = sle_slecontrol_deseq, 
                                                              validationlabel = "sle_slecontrol",
                                                              validationoutfilepath = paste0(outdir, "validation/", "sle_slecontrol/"))
# SLE Prot
sle_sleprot_validation_out <- validation_gsea_function(indeseqtable = sle_sleprot_deseq, 
                                                             validationlabel = "sle_sleprot",
                                                             validationoutfilepath = paste0(outdir, "validation/", "sle_sleprot/"))

# Write out the intermediates:
write_out_intermediate_files(rawcounttable = sle_slecontrol_rawcount_table, metatable = sle_slecontrol_metatable, 
                             compcols = compcols, controlcols = controlcols, 
                             outfilepath = paste0(outdir, "validation/", "sle_slecontrol/", "intermediate_files/"), 
                             labelparam = "sle_slecontrol")

# --------------------------------- Utah COVID Validation ---------------------------------

## EXTERNAL VALIDATION - Utah COVID
dir.create(paste0(outdir, "validation/", "utahcovid_covidcontrol/"), showWarnings = FALSE, recursive = TRUE)
utahcovid_covidcontrol_deseq_file <- file.path(relative_path, "covid_utah_platelet/Supplemental_Table_4_ICUandnonICU_v_control.txt")
utahcovid_covidcontrol_deseq <- read.table(utahcovid_covidcontrol_deseq_file, sep = "\t", header = TRUE, row.names = 2)[,c(c(5:10))]
write.table(utahcovid_covidcontrol_deseq, paste0(outdir, "validation/", "utahcovid_covidcontrol/", "utahcovid_covidcontrol_deseq.csv"), 
            sep = ",", col.names = NA, row.names = TRUE)
utahcovid_covidcontrol_validation_out <- validation_gsea_function(indeseqtable = utahcovid_covidcontrol_deseq, 
                                                              ...
                                                              validationoutfilepath = paste0(outdir, "validation/", "utahcovid_covidcontrol/"))
...
dir.create(paste0(outdir, "validation/", "bongiovanni_rpmp/"), showWarnings = FALSE, recursive = TRUE)
...
write.table(bongiovanni_rpmp_deseq, paste0(outdir, "validation/", "bongiovanni_rpmp/", "bongiovanni_rpmp_deseq.csv"), 
            sep = ",", col.names = NA, row.names = TRUE)
bongiovanni_rpmp_validation_out <- validation_gsea_function(indeseqtable = bongiovanni_rpmp_deseq, 
                                                                  ...
                                                                  validationoutfilepath = paste0(outdir, "validation/", "bongiovanni_rpmp/"))
...
write_out_intermediate_files(rawcounttable = pace_platelet_rawcounttab[,SOI], metatable = pace_platelet_metatable[SOI,], 
                             compcols = compcols, controlcols = controlcols, 
                             outfilepath = paste0(outdir, "validation/", "pace_event_deseq/", "intermediate_files/"), 
...
for (validation_sel in validation_list) {
    ...
    table_sel <- read.table(paste0(outdir, "validation/", label_sel, "/", file_sel), sep = ",", header = TRUE, row.names = 1)
...
# library(glue)
# dotplottab <- read.csv(glue("{outdir}validation/PRESS_set_validation_dotplot_table.csv"))
...
write.table(dotplottab, paste0(outdir, "validation/", "PRESS_set_validation_dotplot_table.csv"), sep = ",", col.names = NA, row.names = TRUE)
pdf(width = 15, height = 10, paste0(outdir, "validation/", "PRESS_set_validation_dotplot.pdf"))
print(pout)
junk <- dev.off()
